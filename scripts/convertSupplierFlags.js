...
const industriesPath = path.join(__dirname, '../json files/SupplierFlags.json');
const outputPath = path.join(__dirname, '../json files/SupplierFlags64.json');
...
(async () => {
  ...
  console.log('✅ Base64 conversion completed. Saved as SupplierFlags64.json');
})();
